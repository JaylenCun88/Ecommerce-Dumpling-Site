  ...
  return (
    <main className="min-h-screen bg-[#fffdf8] px-6 py-6 text-[#273027]">
      ...
      <section className="mx-auto mt-20 max-w-md">
        ...
        <h1 className="mt-4 text-4xl tracking-[-.06em]">Welcome back.</h1>
        <p className="mt-4 leading-7 text-[#586457]">
          Use your email to receive a secure sign-in link. No password needed.
        </p>
        <LoginForm />
      </section>
    </main>
